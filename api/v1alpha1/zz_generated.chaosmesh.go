...
const KindEnvoyChaos = "EnvoyChaos"

// IsDeleted returns whether this resource has been deleted
func (in *EnvoyChaos) IsDeleted() bool {
	return !in.DeletionTimestamp.IsZero()
}

// IsPaused returns whether this resource has been paused
func (in *EnvoyChaos) IsPaused() bool {
	if in.Annotations == nil || in.Annotations[PauseAnnotationKey] != "true" {
		return false
	}
	return true
...
// GetObjectMeta would return the ObjectMeta for chaos
func (in *EnvoyChaos) GetObjectMeta() *metav1.ObjectMeta {
	return &in.ObjectMeta
}

// GetDuration would return the duration for chaos
func (in *EnvoyChaosSpec) GetDuration() (*time.Duration, error) {
	if in.Duration == nil {
		return nil, nil
	}
	duration, err := time.ParseDuration(string(*in.Duration))
...
// GetStatus returns the status
func (in *EnvoyChaos) GetStatus() *ChaosStatus {
	return &in.Status.ChaosStatus
}

// GetRemoteCluster returns the remoteCluster
func (in *EnvoyChaos) GetRemoteCluster() string {
	return in.Spec.RemoteCluster
}

// GetSpecAndMetaString returns a string including the meta and spec field of this chaos object.
func (in *EnvoyChaos) GetSpecAndMetaString() (string, error) {
	spec, err := json.Marshal(in.Spec)
	if err != nil {
		return "", err
	}
...
// EnvoyChaosList contains a list of EnvoyChaos
type EnvoyChaosList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []EnvoyChaos `json:"items"`
}

func (in *EnvoyChaosList) DeepCopyList() GenericChaosList {
	return in.DeepCopy()
}

// ListChaos returns a list of chaos
func (in *EnvoyChaosList) ListChaos() []GenericChaos {
	var result []GenericChaos
	for _, item := range in.Items {
		item := item
		result = append(result, &item)
...
func (in *EnvoyChaos) DurationExceeded(now time.Time) (bool, time.Duration, error) {
	duration, err := in.Spec.GetDuration()
	if err != nil {
		return false, 0, err
	}
...
func (in *EnvoyChaos) IsOneShot() bool {
	return false
}

var EnvoyChaosWebhookLog = logf.Log.WithName("EnvoyChaos-resource")

func (in *EnvoyChaos) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	typedObj, ok := obj.(*EnvoyChaos)
	if !ok {
		return nil, errors.Errorf("expected type *EnvoyChaos, got %T", obj)
	}
	EnvoyChaosWebhookLog.Info("validate create", "name", typedObj.GetName())

	return typedObj.Validate()
}

// ValidateUpdate implements webhook.CustomValidator so a webhook will be registered for the type
func (in *EnvoyChaos) ValidateUpdate(ctx context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	typedOldObj, ok := oldObj.(*EnvoyChaos)
	if !ok {
		return nil, errors.Errorf("expected type *EnvoyChaos, got %T", oldObj)
	}

	typedNewObj, ok := newObj.(*EnvoyChaos)
	if !ok {
		return nil, errors.Errorf("expected type *EnvoyChaos, got %T", newObj)
	}

	EnvoyChaosWebhookLog.Info("validate update", "name", typedOldObj.GetName())
	if !reflect.DeepEqual(typedOldObj.Spec, typedNewObj.Spec) {
		return nil, ErrCanNotUpdateChaos
	}
	return typedNewObj.Validate()
...
// ValidateDelete implements webhook.CustomValidator so a webhook will be registered for the type
func (in *EnvoyChaos) ValidateDelete(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	typedObj, ok := obj.(*EnvoyChaos)
	if !ok {
		return nil, errors.Errorf("expected type *EnvoyChaos, got %T", obj)
	}

	EnvoyChaosWebhookLog.Info("validate delete", "name", typedObj.GetName())

	return nil, nil
}

var _ webhook.CustomValidator = &EnvoyChaos{}

func (in *EnvoyChaos) Validate() ([]string, error) {
	errs := gw.Validate(in)
	return nil, gw.Aggregate(errs)
}

var _ webhook.CustomDefaulter = &EnvoyChaos{}

func (in *EnvoyChaos) Default(_ context.Context, obj runtime.Object) error {
	gw.Default(obj)
	return nil
}
...
func init() {
	...
	SchemeBuilder.Register(&EnvoyChaos{}, &EnvoyChaosList{})
	all.register(KindEnvoyChaos, &ChaosKind{
		chaos: &EnvoyChaos{},
		list:  &EnvoyChaosList{},
	})
	...
	allScheduleItem.register(KindEnvoyChaos, &ChaosKind{
		chaos: &EnvoyChaos{},
		list:  &EnvoyChaosList{},
	})
